package com.aclocationtrack.fcm;
...
import com.aclocationtrack.notification.Constants;
import com.aclocationtrack.notification.MyNotificationManager;
...
//        Log.e(TAG, "onMessageReceived: " + new Gson().toJson(remoteMessage.getNotification()));
        ...
        if (remoteMessage.getData().size() > 0) {
            ...
            Pref pref = PreferencesHelper.getPreferencesInstance(this);
