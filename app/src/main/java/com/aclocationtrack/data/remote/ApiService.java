...
//
    @GET("announcements")
    Observable<Anouncement> getAllAnnouncement(@HeaderMap Map<String, String> headermap);

    @GET("announcements/{id}")
    Observable<AnouncementDetails> getAnnouncementById(@HeaderMap Map<String, String> headermap, @Path("id") int id);

    @GET("downloads")
    Observable<Downloads> getAllDownloads(@HeaderMap Map<String, String> headermap);
