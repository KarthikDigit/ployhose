...
public class RemoteDataSourceHelper implements RemoteDataSource {
    ...
    public Observable<Anouncement> getAllAnnouncement(Map<String, String> headermap) {
        return apiService.getAllAnnouncement(headermap).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }

    @Override
    public Observable<AnouncementDetails> getAnnouncementById(Map<String, String> headermap, int id) {
        return apiService.getAnnouncementById(headermap, id).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }

    @Override
    public Observable<Downloads> getAllDownloads(Map<String, String> headermap) {
        return apiService.getAllDownloads(headermap).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
    ...
    public Observable<Logout> logout(Map<String, String> headermap) {
        return apiService.logout(headermap).subscribeOn(Schedulers.io()).observeOn(AndroidSchedulers.mainThread());
    }
